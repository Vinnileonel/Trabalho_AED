/*
*	CONVÉM PERCEBEREM BEM ESTA CLASSE MAS 
*	NÃO É NECESSÁRIO NEM PERMITIDO APAGAR,
*	ACRESCENTAR OU ALTERAR CÓDIGO AQUI
*
*/
public class Carta implements Cloneable{
	...
	public int verValorOrdem(){
		//o valor de ordem atribui um valor sequencial sequencial a cada carta
